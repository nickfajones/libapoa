...
class signal_handler_base_impl :
  ...
  protected:
    ...
    typedef asio::posix::stream_descriptor::native_handle_type
      basic_signal_descriptor;

  public:
    explicit signal_handler_base_impl(asio::io_context& io_context);
  ...
  public:
    class sigaction_handler :
      ...
      {
      protected:
        sigaction_handler(asio::io_context& io_context);
...
class posix_signal_handler_impl : public signal_handler_base_impl
  ...
  protected:
    class posix_sigaction_handler :
      ...
      {
      public:
        posix_sigaction_handler(asio::io_context& io_context);
...
class signalfd_signal_handler_impl : public signal_handler_base_impl
  ...
  protected:
    class signalfd_sigaction_handler :
      ...
      {
      public:
        signalfd_sigaction_handler(asio::io_context& io_context);
